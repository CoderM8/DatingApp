...
class PairNotifications extends ParseObject implements ParseCloneable {
  static const String keyNotification = 'PairNotifications';
  ...
  static const String keyDeletedUsers = 'DeletedUsers';
  static const String keyUnreadCount = 'UnreadCount';
  PairNotifications() : super(keyNotification);
  PairNotifications.clone() : this();
  ...
  @override
  clone(Map<String, dynamic> map) => PairNotifications.clone()..fromJson(map);

  @override
  PairNotifications fromJson(Map<String, dynamic> objectData) {
  ...
  List get deletedUsers => get<List>(keyDeletedUsers)!;
  set deletedUsers(List? deletedUsers) => set<List>(keyDeletedUsers, deletedUsers!);

  int get unreadCount => get<int>(keyUnreadCount)!;
  set unreadCount(int? unreadCount) => set<int>(keyUnreadCount, unreadCount!);
}
