...
class Visits extends ParseObject implements ParseCloneable {
  static const String keyHeartLike = 'Visits';
  ...
  Visits() : super(keyHeartLike);

  Visits.clone() : this();

  @override
  Visits clone(Map<String, dynamic> map) => Visits.clone()..fromJson(map);
